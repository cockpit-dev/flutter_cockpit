...
void main() {
  ...
  test(
    ...
    expect(utf8.decode(base64Decode(response.bytesBase64!)),
  ...
  test('bridge protocol returns structured errors instead of leaking failures',
      () async {
    ...
    final malformedRequestText = await handlerFailureProtocol.handleRawMessage(
  ...
  test('bridge response parser rejects malformed response fields', () {
    expect(
      () => CockpitRemoteBridgeResponse.fromJson(
        const <String, Object?>{
