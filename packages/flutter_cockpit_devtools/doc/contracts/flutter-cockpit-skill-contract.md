...
- app-scoped desktop recording that defaults to host adapters when `app.json` carries a platform app id or process id; direct remote recording remains available for explicit remote-session work
