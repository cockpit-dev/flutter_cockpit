...
import 'package:flutter_cockpit_devtools/src/mcp/resources/cockpit_apps_resource.dart';
import 'package:flutter_cockpit_devtools/src/session/cockpit_remote_session_handle.dart';
import 'package:test/test.dart';

void main() {
  test('app resource returns the newest tracked record for a shared app id',
      () async {
