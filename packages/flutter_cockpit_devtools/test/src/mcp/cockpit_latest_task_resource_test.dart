...
import 'package:flutter_cockpit_devtools/src/application/cockpit_read_latest_task_summary_service.dart';
...
import 'package:flutter_cockpit_devtools/src/mcp/resources/cockpit_latest_task_resource.dart';
import 'package:test/test.dart';

void main() {
  test('latest task resource includes warnings from the latest task snapshot',
      () async {
