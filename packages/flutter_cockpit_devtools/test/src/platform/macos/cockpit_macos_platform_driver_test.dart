...
import 'package:flutter_cockpit_devtools/src/platform/macos/cockpit_macos_platform_driver.dart';
import 'package:test/test.dart';

void main() {
  test('macos platform driver reports desktop automation capabilities',
      () async {
  ...
  test('macos platform driver does not expose evidence adapters by default',
      () {
    final driver = CockpitMacosPlatformDriver();
  ...
  test('macos platform driver exposes evidence adapters when app id is set',
      () {
