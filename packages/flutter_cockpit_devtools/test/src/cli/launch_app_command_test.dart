...
void main() {
  test(
    'launch-app defaults project-dir and desktop platform when safe',
    () async {
  ...
  test(
    'launch-app persists the default latest app handle path when omitted',
    () async {
      final tempDir = await Directory.systemTemp.createTemp(
        ...
        ..addCommand(
          LaunchAppCommand(
            ...
            launch: (request) async {
              ...
              return CockpitLaunchAppResult(app: handle, appJsonPath: path);
            },
          ),
        );
