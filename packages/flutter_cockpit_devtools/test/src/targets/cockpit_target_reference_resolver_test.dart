...
void main() {
      ...
      appReferenceResolver: CockpitAppReferenceResolver(
        portForwarder: CockpitAndroidPortForwarder(
          processRunner: (_, __) async => ProcessResult(
            0,
            0,
            'emulator-5554 tcp:57331 tcp:47331\n',
            '',
          ),
  ...
  test('projects android app handle files into refreshed flutter targets',
      () async {
    final tempDir = await Directory.systemTemp.createTemp(
  ...
  test('projects physical ios app handle files into refreshed flutter targets',
      () async {
    final tempDir = await Directory.systemTemp.createTemp(
