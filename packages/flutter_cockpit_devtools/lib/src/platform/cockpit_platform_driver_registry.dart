...
typedef CockpitPlatformDriverFactory =
    CockpitPlatformDriver Function({required String deviceId});
...
final class CockpitPlatformDriverRegistry {
  ...
  CockpitPlatformDriver? resolve({
    ...
    return switch (platform) {
      ...
      'linux' => CockpitLinuxPlatformDriver(appId: appId, processId: processId),
