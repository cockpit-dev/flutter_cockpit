...
final class HotReloadCommand extends CockpitCliCommand {
  ...
  String get helpExample =>
      'cockpit hot-reload --app-json /tmp/app.json --stdout-format json | jq \'{reloadGeneration: .status.reloadGeneration, lastReloadSucceeded: .status.lastReloadSucceeded, lastReloadMode: .status.lastReloadMode}\'';
