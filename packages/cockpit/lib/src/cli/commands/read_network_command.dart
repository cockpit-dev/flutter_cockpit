...
final class ReadNetworkCommand extends CockpitCliCommand {
  ...
  String get helpExample =>
      'cockpit read-network --app-json /tmp/app.json --uri-contains /api --only-failures --stdout-format json | jq \'{routeName, failureCount: .summary.failureCount, endpoints: [.endpointSummaries[] | {uriPattern,requestCount,failureCount}]}\'';
