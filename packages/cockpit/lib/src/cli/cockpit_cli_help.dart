...
final class CockpitCliRootRunner extends CommandRunner<int> {
  ...
  String get usage {
    ...
    _writeSection(buffer, 'Core loop', const <String>[
      'list-targets',
      'launch-app',
      'launch-target',
    ...
    buffer.writeln();
    _writeSection(buffer, 'Workspace', const <String>[
      'pub-dev-search',
      'pub',
      'run-shell',
      'read-package-uris',
    ...
    buffer.writeln();
    _writeSection(buffer, 'Development sessions', const <String>[
    ...
    buffer.writeln();
    _writeSection(buffer, 'Evidence', const <String>[
      'read-network',
      'read-errors',
      'read-logs',
      'start-recording',
  ...
  String? get usageFooter => <String>[
    ...
    '  capture-screenshot --name acceptance',
    '  hot-reload',
    '  read-errors --max-errors 10',
    ...
    '  pub --command get',
    'If a flag or JSON shape is unclear, run "cockpit help <command>" before guessing.',
...
abstract base class CockpitCliCommand extends Command<int> {
  CockpitCliCommand() {
    argParser
      ...
      ..addOption('output', help: cockpitOutputOptionHelp)
      ..addOption(
        'output-format',
