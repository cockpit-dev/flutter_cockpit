...
void main() {
  ...
  test('devtools command starts the local observability API', () async {
    ...
    expect(output.toString(), contains('apiBaseUrl=http://127.0.0.1:'));
    expect(output.toString(), contains('/api/'));
  ...
  test('devtools command supports json stdout format', () async {
    ...
    expect(decoded['apiBaseUrl'], startsWith('http://127.0.0.1:'));
    expect(decoded['apiBaseUrl'], endsWith('/api/'));
