...
import 'package:cockpit/src/platform/windows/cockpit_windows_platform_driver.dart';
import 'package:test/test.dart';

void main() {
  test(
    'windows platform driver reports desktop automation capabilities',
    () async {
  ...
  test(
    'windows platform driver does not expose evidence adapters by default',
    () {
      final driver = CockpitWindowsPlatformDriver();
  ...
  test(
    'windows platform driver exposes evidence adapters when app id is set',
    () {
