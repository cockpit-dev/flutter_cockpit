...
import 'package:cockpit/src/platform/linux/cockpit_linux_platform_driver.dart';
import 'package:test/test.dart';

void main() {
  test(
    'linux platform driver reports desktop automation capabilities',
    () async {
  ...
  test(
    'linux platform driver does not expose evidence adapters by default',
    () {
      final driver = CockpitLinuxPlatformDriver();
  ...
  test(
    'linux platform driver exposes evidence adapters when app id is set',
    () {
