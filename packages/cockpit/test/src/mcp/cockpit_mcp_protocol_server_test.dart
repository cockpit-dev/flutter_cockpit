...
import 'package:cockpit/src/mcp/cockpit_mcp_server.dart';
import 'package:cockpit/src/mcp/cockpit_mcp_tool.dart';
import 'package:cockpit/src/mcp/core/cockpit_mcp_prompt.dart';
...
final class _ProtocolTestEnvironment {
  ...
  Future<ServerConnection> initialize() async {
    ...
    expect(result.serverInfo.name, 'cockpit');
