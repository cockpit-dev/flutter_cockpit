import 'package:cockpit/src/application/cockpit_compact_json.dart';
import 'package:test/test.dart';

void main() {
  test('cockpitCompactJsonValue omits null fields recursively from maps', () {
    final compacted =
        cockpitCompactJsonValue(<String, Object?>{
              'sessionId': 'session-1',
              ...
              'entries': <Object?>[
                <String, Object?>{'label': 'Inbox', 'tooltip': null},
              ],
            })
    ...
    expect(compacted['snapshot'], <String, Object?>{'route_name': '/home'});
