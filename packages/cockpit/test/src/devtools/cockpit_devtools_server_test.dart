...
''',
    ...
    test('serves token-protected run APIs without a bundled UI', () async {
      final tempDir = await Directory.systemTemp.createTemp(
      ...
      final root = await _get(handle.uri);
      expect(root.statusCode, HttpStatus.notFound);
      expect(root.body, 'not found');
    ...
    test('reports invalid bundle JSON without failing the API', () async {
      final tempDir = await Directory.systemTemp.createTemp(
