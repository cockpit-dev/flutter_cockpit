...
import 'package:cockpit/src/mcp/core/cockpit_mcp_stdio_channel.dart';
  ...
  Future<_VerificationReport> run() async {
    ...
    try {
      ...
      promptReport['status'] =
          ...
          ? 'passed'
          : 'failed';
      if (promptReport['status'] != 'passed') {
        throw StateError(
          'MCP prompt no longer carries required AI-first loop guidance: '
          '${jsonEncode(promptReport)}',
        );
      }
