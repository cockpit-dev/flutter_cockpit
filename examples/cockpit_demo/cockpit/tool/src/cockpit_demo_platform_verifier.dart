...
String cockpitDemoDefaultProjectDir({
  ...
  final isDevelopmentShell =
      p.basename(candidate) == 'cockpit' &&
      p.basename(p.dirname(candidate)) == 'cockpit_demo';
  return isDevelopmentShell ? candidate : fallback;
}
