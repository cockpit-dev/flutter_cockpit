...
void main() {
  test(
    'rapid verifier requests default to the standalone shell entrypoint',
    () {
      expect(
  ...
  test(
    ...
    () async {
      ...
      expect(captureRequests.map((request) => request.appHandlePath), <String>[
        '/workspace/examples/cockpit_demo/cockpit/.dart_tool/cockpit_rapid_dev/macos/app.json',
        '/workspace/examples/cockpit_demo/cockpit/.dart_tool/cockpit_rapid_dev/ios/app.json',
        '/workspace/examples/cockpit_demo/cockpit/.dart_tool/cockpit_rapid_dev/android/app.json',
      ]);
      expect(
